        ...
        <div className="max-w-xl mx-auto flex flex-col gap-12 animate-fade-up pb-10">
            <header className="flex items-center justify-between">
                <div className="flex flex-col">
                    <span className="text-caption">Statistik Anda</span>
                    <h1 className="text-large-title text-text-primary mt-1">Progres</h1>
                </div>
                <div className="h-12 px-4 rounded-2xl bg-stealth-surface border border-stealth-border flex items-center gap-2">
                    ...
                    <span className="text-mono !text-[10px] text-text-primary">
                        Hari ini: {todayCompletions}/{settings.dailyTarget}
                    </span>
                </div>
            </header>
            ...
            <div className="card-stealth p-6 flex flex-col gap-6">
                <div className="flex justify-between items-start">
                    <div className="flex flex-col gap-0.5">
                        <span className="text-mono !text-neon !text-[9px]">Alur Aktivitas</span>
                        <h3 className="text-2xl font-black tracking-tighter text-text-primary">90 Hari Terakhir</h3>
                    </div>
                    {todayCompletions > 0 && (
                        <div className="bg-neon/10 border border-neon/20 px-3 py-1 rounded-full flex items-center gap-1.5 animate-pulse">
                            ...
                            <span className="text-mono !text-neon !text-[8px] tracking-[1px]">Aktif Hari Ini</span>
                        </div>
                    )}
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 mt-6 sm:mt-8 mb-6 sm:mb-8">
                <div className="card-stealth p-6 flex flex-col justify-between h-40">
                    <div className="flex flex-col gap-1">
                        <span className="text-caption">Konsistensi</span>
                    ...
                    <div className={cn(
                        ...
                        streak > 0 ? "text-neon" : "text-text-muted"
                    )}>
                        <Zap size={10} strokeWidth={3} className={streak > 0 ? "animate-pulse" : ""} />
                        <span className="text-mono !text-[8px] uppercase tracking-widest text-inherit">
                            {streak > 0 ? "Konsistensi Harian" : "Mulai Membaca"}
                        </span>
                    </div>
                </div>
                <div className="card-neon p-6 flex flex-col justify-between h-40 relative overflow-hidden group">
                    ...
                    <div className="flex flex-col gap-1 relative z-10">
                        ...
                        <div className="flex justify-between items-center opacity-40">
                            <span className="text-mono !text-black !text-[8px]">Target Khatam</span>
            ...
            <div className="card-stealth p-6 flex items-center justify-between group active:scale-[0.98] cursor-pointer">
                <div className="flex flex-col">
                    <span className="text-caption">Total Hari Aktif</span>
                    <h2 className="text-2xl font-black text-text-primary tracking-tight mt-1">{daysActive} Hari</h2>
                </div>
