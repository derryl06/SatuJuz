    ...
    return (
        <html lang="en">
            <body className={cn(
                ...
                <ThemeProvider>
                    <div className="w-full max-w-screen-xl mx-auto min-h-screen flex flex-col relative transition-all duration-500">
                        <main className="flex-1 px-5 sm:px-8 pb-32 pt-8">
                            {children}
                        </main>
                    </div>
                    <GlassTabBar />
